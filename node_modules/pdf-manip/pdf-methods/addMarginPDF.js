const { degrees, PageSizes, PDFDocument } = require("pdf-lib");
...
//   var pdfDoc = await PDFDocument.load(fs.readFileSync("../doc.pdf"));
//   pdfDoc = await addMarginPDF(pdfDoc, [100, 100, 100, 100], 0);
//   const pdfBytes = await pdfDoc.save();
//   fs.writeFileSync("./doc2.pdf", pdfBytes);
